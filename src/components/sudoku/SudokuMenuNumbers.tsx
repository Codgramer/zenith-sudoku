        ...
        return (
          <Button
            className={clsx("relative font-bold", {
              "bg-surface-secondary dark:bg-gray-800 text-text-disabled dark:text-gray-500": occurrences === 9,
              "bg-danger-light dark:bg-danger-dark": showOccurrences && occurrences > 9,
              "bg-primary-accent dark:bg-primary-dark text-white":
          ...
          >
            {showOccurrences && (
              <div className="absolute right-0 bottom-0 h-3 w-3 rounded-xl bg-primary-dark text-xxs text-white opacity-70 sm:right-1 sm:bottom-1 sm:h-4 sm:w-4 sm:text-xs">
                {occurrences}
              </div>
            )}
            {n}
