...
const GridShortcuts: React.FC<{
  ...
  clearAllNotes: () => void; // New prop added
  undo: () => void;
  redo: () => void;
  sudoku: Cell[];
  ...
  getHint,
  setNotes,
  clearAllNotes, // Destructure new prop
  undo,
  redo,
  sudoku,
  activeCell,
  ...
  React.useEffect(() => {
    ...
    // New shortcut to clear all notes
    hotkeys("ctrl+c,cmd+c", ShortcutScope.Game, () => {
      stateRef.current.clearAllNotes();
      return false;
    });
